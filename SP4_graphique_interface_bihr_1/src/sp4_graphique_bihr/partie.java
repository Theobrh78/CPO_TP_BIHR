...
public class partie {
    ...
    public void initialiserPartie(){
        ...
        System.out.println("Choisissez le premier pseudo");
        joueur J1= new joueur(sc.nextLine());
        System.out.println("Choisissez le second pseudo");
            ...
            mode = sc.nextInt();
                    ...
                    if (mode==2){
                       ...
                       // if (plateau.presenceJeton(ligne, colonne)==true){
                        plateau.recupererJeton(ligne-1, colonne-1);
                        plateau.supprimerJeton(ligne-1,colonne-1);
                        plateau.tasserColonne(ligne,colonne);
                        //}
                        //else {
